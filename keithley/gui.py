...
class GraphFrame(wx.Frame):
    ...
    def __init__(self, data, data_access):
    ...
    def init_plot(self):
        ...
        self.axes.set_title('Keithley Voltage', size=12)
    ...
    def draw_plot(self):
        ...
        with self.data_access:
            self.plot_data.set_xdata(self.data['t'])
            self.plot_data.set_ydata(self.data['V'])
